...
# Alrededor de Estados Unidos - Proyecto Cuarto y Quinto Sprint de Practicum por <a href="https://github.com/brularre/">Bruno Larraín</a>

## Sobre el Proyecto

¡Hola! Si estás leyendo esto, estás revisando y/o visitando mi portafolio para ver mi trabajo. Sigue mi progreso en el Curso de Desarrollo Web de Practicum, esta vez estoy en el quinto Sprint, continuando el cuarto que incorpora Javascript y uno de mis puntos favoritos, pues se ve como se abren todas las posibilidades del desarrollo web.
...
En este proyecto se profundizo en el uso de lógica Javascript para añadir funcionalidad a la creación de formulario y elementos.
